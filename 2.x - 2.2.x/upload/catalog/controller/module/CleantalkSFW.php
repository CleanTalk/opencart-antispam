...
class CleantalkSFW extends CleantalkHelper
{
	...
	*/	
	public function sfw_die($api_key, $cookie_prefix = '', $cookie_domain = ''){
		...
		// File exists?
		if(file_exists(DIR_APPLICATION . '../catalog/controller/module/module/sfw_die_page.html')){
			$sfw_die_page = file_get_contents(DIR_APPLICATION . '../catalog/controller/module/module/sfw_die_page.html');
		}else{
			die("IP BLACKLISTED");
		}
